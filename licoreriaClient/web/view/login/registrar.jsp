<?php
    ...
    if(isset($_SESSION["usuario"])){
        ...
        if($usuario != ""){
            echo '<script> window.location.href="'.SERVERURL.'acerca/" ;</script>';
        }
    }
...
<html lang="es">
    <head>
        <title>LICORERIA | Registrarse</title>
        <meta charset="utf-8" />
        <meta content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" name="viewport"/>
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
        <link rel="icon" type="image/png" href="<?=SERVERURL?>archives/assets/licoreria.jpg" sizes="64x64"/>
    ...
    <body>
    <div id="preloader">
        <div id="loader" style="background: url('<?=SERVERURL;?>archives/assets/licoreria.jpg') no-repeat center 0; background-size: 200px;top: 30%;">
        </div>
    </div>
