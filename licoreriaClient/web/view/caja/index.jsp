                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="shop-panel text-white bg-red">
                                    ...
                                    <h3><strong >S./ </strong><strong class="final-price">0</strong></h3>
                                </div>
                                ...
                                <div class="shop-panel mt-2  text-white bg-blue">
                                    ...
                                    <h4 class="btn-block"><strong class="cambio">S./ 0</strong></h4>
                                </div>
                                <!--div class="form-group bmd-form-group">
                  ...
                  <div class="tab-content text-center">
                    ...
                    <div class="tab-pane" id="credito">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group bmd-form-group">
                                    <label class="control-label bmd-label-static">NÂ° Meses</label>
        ...
        $.post('<?=SERVERURL;?>caja/barra_producto/',{codigo},function(res){
            if (res == 1){
                ...
                if(document.getElementById("pro-n-"+idproducto)){
                    showNotification('bottom','center','El producto ya fue aÃ±adido a la lista','warning');
