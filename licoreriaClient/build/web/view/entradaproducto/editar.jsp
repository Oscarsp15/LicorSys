    ...
    <div class="container-fluid">
        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    <form autocomplete="off" class="FormularioAjax" action = "#" method="POST" data-form="save" >
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="bmd-label-floating">NÂ° de Documento</label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="form-group bmd-form-group">
                                        <label class="bmd-label-floating"> ObservaciÃ³n</label>
