            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form autocomplete="off" method="POST" ectype="multipart/form-data">       
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select id="tipoingreso" name="tipo_ingreso" class="custom-select">
                                        ...
                                        <option value="4">INGRESO POR TRASPASO ALMACÃ‰N</option>
                        ...
                        <a href="index.jsp" class="btn btn-rose pull-right">Regresar</a>                
...
<script>
    ...
    $("#btn-modal").click(function(){
        ...
        totalneto();
        showNotification('bottom','center','Se actualizÃ³ la cantidad del producto','success');
    });
