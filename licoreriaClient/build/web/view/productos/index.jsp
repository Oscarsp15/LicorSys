                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="alert alert-warning">
                                                                <b>IMPORTANTE</b> para importar registros desde excel es importante que usted utilice la plantilla que genera el sistema. Tambi̩n asegurese de tener unidades de medida, marcas y categorias, con el fin de que su registros de la base de datos en la plantilla facilite su uso, y no de cualquier tipo de error.
                                                            </div>
