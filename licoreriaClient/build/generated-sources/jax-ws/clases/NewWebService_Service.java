 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://clases/", wsdlLocation = "http://localhost:8080/licoreriaServer/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://clases/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/licoreriaServer/NewWebService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://clases/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://clases/", "NewWebServicePort"), NewWebService.class, features);
    }
